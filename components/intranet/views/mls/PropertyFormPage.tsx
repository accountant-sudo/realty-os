      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2 text-[13px]">
          ...
          <span className="text-text-1 font-medium">
            {isNew ? 'New property' : (form.address || 'Edit')}
          </span>
        </div>
      ...
      <div className="flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="bg-surface border border-border rounded-[10px] p-5 mb-4">
            <p className={SECTION}>Basic information</p>
          ...
          {isUS && (
            <>
              <div className="bg-surface border border-border rounded-[10px] p-5 mb-4">
                <p className={SECTION}>Property details</p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
          ...
          {!isUS && (
            <>
              <div className="bg-surface border border-border rounded-[10px] p-5 mb-4">
                <p className={SECTION}>Owner information</p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
        ...
        <div className="w-[320px] shrink-0 sticky top-0">
          <div className="bg-surface border border-border rounded-[10px] overflow-hidden">
            ...
            <div className="px-5 pt-5 pb-4 border-b border-border">
              ...
              <div className="text-[15px] font-semibold text-text-1 leading-snug mt-2">
                {form.address || <span className="text-text-3 font-normal">No address</span>}
              </div>
            ...
            <div className="px-5 py-4 space-y-3">
              ...
              {isUS && form.rentalStatus && (
                <div className="flex items-center justify-between">
                  <span className="text-[12px] text-text-3">Rental</span>
              ...
              {!isUS && (form.bedrooms || form.bathrooms) ? (
                <div className="flex items-center justify-between">
                  <span className="text-[12px] text-text-3">Layout</span>
                  <span className="text-[12px] text-text-2">
                    {form.bedrooms ? `${form.bedrooms} bed.` : ''}{form.bedrooms && form.bathrooms ? ' · ' : ''}{form.bathrooms ? `${form.bathrooms} bath` : ''}
                  </span>
                </div>
              ) : null}
              ...
              {!isUS && form.totalArea ? (
                <div className="flex items-center justify-between">
                  <span className="text-[12px] text-text-3">Total area</span>
            ...
            <div className="px-5 pb-5 pt-1 border-t border-border">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[11px] text-text-3 font-semibold uppercase tracking-wider">Completeness</span>
              ...
              <div className="text-[11px] text-text-3 mt-1.5 text-right">{progress.pct}% complete</div>
            </div>
          </div>
          ...
          {!canSave && (
            <p className="text-[11px] text-text-3 text-center mt-3">
              Address and price required to save
            </p>
          )}
        </div>
      </div>
