    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 32px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(195,155,60,0.08)",
        }}
      >
        ...
        <div className="flex flex-col gap-1.5 mb-3.5">
          ...
          <input
            ...
            onFocus={(e) => {
              e.currentTarget.style.borderColor = "rgba(195,155,60,0.6)";
              e.currentTarget.style.background = "rgba(255,255,255,0.08)";
            }}
            onBlur={(e) => {
              e.currentTarget.style.borderColor = "rgba(195,155,60,0.2)";
        ...
        <button
          className="w-full py-3 mt-2 rounded-[8px] text-white text-[14px] font-bold tracking-[0.04em] cursor-pointer border-none transition-opacity active:scale-[0.98] hover:opacity-90"
          style={{
            background: "linear-gradient(135deg, #C39B3C 0%, #A07828 100%)",
            fontFamily: "inherit",
          }}
        ...
        <div className="mt-2.5 text-[12px] text-[#e07070] text-center min-h-[18px]">
          {error}
        </div>
      </div>
    </div>
